...
<link rel="stylesheet" type="text/css"
	href="/resources/styles/courses_styles.css">
<link rel="stylesheet" type="text/css"
	href="/resources/styles/courses_responsive.css">
<link
	...
	<section class="bookinfo">
		<div class="container px-4 px-lg-5 my-5">
			<div class="row gx-4 gx-lg-5 align-items-center">
				<div class="col-md-6">
					<img class="card-img-top mb-5 mb-md-0" src="${bookDetail.photo}"
						alt="..." />
				</div>
				<div class="col-md-6">
					...
					<div class="fs-5 mb-5 mt-3">
						<span class="text-decoration-line-through"><c:out
								value="${bookDetail.author}" /></span>
					</div>
					<p id="container">
						<c:out value="${bookDetail.bookDescription}" />
					</p>
					<div class="d-flex">
						<button id="btn" class="btn btn-outline-dark flex-shrink-0"
		...
		<div class="container px-4 px-lg-5 my-5"
			...
			<div class="row gx-4 gx-lg-5 align-items-center">
				<div class="col-md-12">
					...
					<dl>
						<dd>
							<span class="bold">페이지 수 : </span>
							<c:out value="${bookDetail.pageCount}" />
							<br> <span class="bold">무게 : </span>
							<c:out value="${bookDetail.weight}" />
							<br> <span class="bold">크기 : </span>
							<c:out value="${bookDetail.bookSize}" />
						</dd>
						<dt>
               ...
               <!-- "도서가 장바구니에 추가되었습니다." 메시지 표시 -->
					...
					<div class="col-md-4">
						<button type="button" class="btn btn-info">구매신청</button>
					</div>
					<div class="col-md-4">
						<button type="button" class="btn btn-primary"
							onclick='backtolist()'>뒤로가기</button>
					</div>
				</div>
			</div>
		</div>
		<div class="rating-container">
			<div class="rating-box">
				<div class="rating-bar">
					<span class="star-label">★★★★★</span> <span class="barGraphBase">
						<span class="barGraph innerTxt rating-5"
						style="width: ${bookDetail.star5Count}"> <em class="barTxt">${bookDetail.star5Count}</em>
					</span>
					</span>
				</div>
				<div class="rating-bar">
					<span class="star-label">★★★★☆</span> <span class="barGraphBase">
						<span class="barGraph innerTxt rating-4"
						style="width: ${bookDetail.star4Count}"> <em class="barTxt">${bookDetail.star4Count}</em>
					</span>
					</span>
				</div>
				...
				<div class="rating-bar">
					<span class="star-label">★★★☆☆</span> <span class="barGraphBase">
						<span class="barGraph innerTxt rating-3"
						style="width: ${bookDetail.star3Count}"> <em class="barTxt">${bookDetail.star3Count}</em>
					</span>
					</span>
				</div>
				...
				<div class="rating-bar">
					<span class="star-label">★★☆☆☆</span> <span class="barGraphBase">
						<span class="barGraph innerTxt rating-2"
						style="width: ${bookDetail.star2Count}"> <em class="barTxt">${bookDetail.star2Count}</em>
					</span>
					</span>
				</div>
				...
				<div class="rating-bar">
					<span class="star-label">★☆☆☆☆</span> <span class="barGraphBase">
						<span class="barGraph innerTxt rating-1"
						style="width: ${bookDetail.star1Count}"> <em class="barTxt">${bookDetail.star1Count}</em>
					</span>
					</span>
				</div>
			</div>
	...
	<div id="bookDetail" data-isbn13="${bookDetail.isbn13}">
		...
		<div style="margin-top: 5%">
			...
			<div class="row">
				...
				<p>
					isbn13 :
					<c:out value="${bookDetail.isbn13}" />
				</p>

				<p>
					Average Rating:
					<fmt:formatNumber value="${bookDetail.averageRating}"
						minFractionDigits="1" />
				</p>

				<p>
					Review Count:
					<c:out value="${bookDetail.reviewCount}" />
				</p>
