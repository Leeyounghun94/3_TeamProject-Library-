   ...
   <div class="home2">
	...
	<div class="col-lg-12">
		<div class="panel panel-default" style="padding-left:10%;">
			...
			<div class="panel-body">
				...
				<div class='row'>
					<div class="col-lg-12">
						...
						<form id='searchForm' action="/library/listReview" method='get' align="end">
							<select name='type'>
								<option value=""
							...
							<input type='hidden' name='category' value='<c:out value="${ pageMaker.cri.category}"/>'><!-- 게시판 분류 2024 10 05 -->
			...
			<form id='actionForm' action="/library/listReview" method='get'><!-- Jstl  -->
				<input type='hidden' name='pageNum' value='${pageMaker.cri.pageNum}'>
				<input type='hidden' name='amount' value='${pageMaker.cri.amount}'>
				<input type='hidden' name='type' value='<c:out value="${ pageMaker.cri.type }"/>'>
				<input type='hidden' name='keyword'	value='<c:out value="${ pageMaker.cri.keyword }"/>'>
				<input type='hidden' name='category' value='<c:out value="Review"/>'>	<!-- 게시글을 눌러 상세 페이지 보기 또한 같이 전달됨 2024 09 28 -->
