...
<div class="container" align="center">
	...
	<div class="col-md-5" style="border:1px solid white; float:left; margin-right:100px;">
					<img class="card-img-top" src="/resources/images/bookrent.png" alt="https://unsplash.com/@kellybrito">
                       <div class="section_title text-center">                         
                            <div class="featurs-content text-center" style="border:1px gray; color:gray;">
                               <a href="#" onclick="location.href='/library/reservation/BookReservation'"><h1>도서 대출 및 예약</h1></a>
                            </div>
                        </div>
                    </div><!-- 도서 예약 end -->
	...
	<div class="col-md-5" style="border:1px solid white; float:left;">
					<img class="card-img-top" src="/resources/images/studying.png" alt="https://unsplash.com/@kellybrito">					
                        <div class="section_title text-center">                          
                            <div class="featurs-content text-center">
                                
                                <a href="#" onclick="location.href='/library/reservation/StudyReservation'"><h1>열람실 예약</h1></a>
                            </div>
                        </div>
                    </div><!-- 열람실 예약 end -->
